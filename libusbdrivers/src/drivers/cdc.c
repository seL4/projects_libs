...
static int usb_cdc_config_cb(void *token, int cfg, int iface, struct anon_desc *desc)
{
...
static void usb_cdc_mgmt_msg(struct usb_cdc_device *cdc, uint8_t req_type,
